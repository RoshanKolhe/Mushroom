...
export default function UserNewViewForm({ currentUser }) {
        ...
        <Grid xs={12} md={8}>
          <Card sx={{ p: 3 }}>
            ...
            >
              ...
              <RHFSelect fullWidth name="gender" label="Gender" disabled>
                {[
              ...
              {values.role === 'hut_user' ? (
                <RHFSelect fullWidth name="userType" label="User Type" disabled>
                  {[
              ...
              {values.userType === 'shg' ? <RHFTextField name="shgName" label="SHG Name" disabled/> : null}
              {values.role === 'hut_user' ? (
                <RHFSelect fullWidth name="investmentType" label="Investment Type" disabled>
                  {[
              ...
              {values.investmentType === 'bankLoan' ? (
                <>
                  ...
                  />
                  <RHFTextField name="emiAmount" label="Emi Amount" disabled/>
                  <RHFSelect fullWidth name="emiDate" label="Emi Date" disabled>
                    {days.map((option) => (
                      <MenuItem key={option.value} value={option.value}>
                        {option.name}
                      </MenuItem>
