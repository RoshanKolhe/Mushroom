...
//
import ClusterQuickEditForm from './cluster-quick-edit-form';
...
export default function ClusterTableRow({
  ...
  const { name, user, noOfHuts, isActive, totalCultivation } = row;
  ...
  return (
    <>
      <TableRow hover selected={selected}>
        ...
        <TableCell sx={{ whiteSpace: 'nowrap' }}>{noOfHuts}</TableCell>
      ...
      <ClusterQuickEditForm
        currentCluster={row}
        open={quickEdit.value}
        onClose={quickEdit.onFalse}
        onRefreshClusters={onRefreshClusters}
      />
