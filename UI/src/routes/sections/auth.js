...
// OTP sign in
const SignInView = lazy(() => import('src/pages/auth/OTP_login/SignIn'));
const OtpPage = lazy(() => import('src/pages/auth/OTP_login/OtpPage'));
...
export const authRoutes = [
  {
    path: 'auth',
    children: [authAmplify, authAuth0, authFirebase, authJwt, signIn],
  },
];
